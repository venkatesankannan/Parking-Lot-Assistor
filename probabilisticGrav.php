...
$query2= "SELECT avg(`available`)*'$conge' as `available_slots` from `availability` where `block_id` IN ('$a','$b') and DATE_FORMAT(timestamp,'%H:%i:%s') Like '$tim'";
...
//if(isset($a) && isset($b)){
$query2= "SELECT avg(`available`)*'$co' as `available_slots` from `availability` where `block_id` IN ('$a','$b') and DATE_FORMAT(timestamp,'%H:%i:%s') Like '$ti'";
...
function getMarker($orglat,$orglong,$deslat,$deslong){
	//creating map
$map = new Map();
...
//creating marker
	$marker = new Marker();
   $marker->setPrefixJavascriptVariable('marker_');
  $marker->setPosition($orglat,$orglong, true);
  $marker->setAnimation(Animation::DROP);
 ...
 $marker2 = new Marker();
  $marker2->setPrefixJavascriptVariable('marker_two');
  $marker2->setPosition($deslat,$deslong, true);
  $marker2->setAnimation(Animation::DROP);
...
<head>
<meta charset="utf-8">
<title>Probabilistic Gravitational Pull</title>
...
<h1 align="center">Probabilistic Gravitational Pull</h1>
<h2>Please enter the following information:</h2>
 <dd><table width="100%" border="0">
  ...
  <h3>Provide information for historical data analysis:</h3>
<dd><table width="25%" border="0">
  <tr>
